 ...
 */
public class ParentApp_parent extends TestBase {
...
//            }
    ...
    public void beforeSuite_normal() {
        RunningParameter.project_name = "middle_parentapp_normal";
    ...
    public void beforeSuite_exception() {
        RunningParameter.project_name = "middle_parentapp_exception";
        RunningParameter.monitor_projectId = 3;
        RunningParameter.projectName = "parentapp";
    }
