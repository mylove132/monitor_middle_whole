 ...
 */
public class Api1_7 extends Mall {
    @Override
    public void getParams(Map<String, String> param) {
        ...
        getRequestParms.add(new BasicNameValuePair("orderId", param.get("orderId")));
        getRequestParms.add(new BasicNameValuePair("orderStatus", param.get("orderStatus")));
