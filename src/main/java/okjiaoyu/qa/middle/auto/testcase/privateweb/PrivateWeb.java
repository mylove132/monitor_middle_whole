package okjiaoyu.qa.middle.auto.testcase.privateweb;
 ...
 *
 */
public class PrivateWeb extends TestBase{
...
//    public static JSONObject account_commonUp = new JSONObject();
    ...
    public void beforeSuite_normal(){
        RunningParameter.project_name = "privateweb_normal";
        RunningParameter.monitor_projectId = 23;
        RunningParameter.projectName = "privateweb";
    }

    @BeforeSuite(groups = { "exception" })
    public void beforeSuite_exception(){
        RunningParameter.project_name = "privateweb_exception";
        RunningParameter.monitor_projectId = 23;
        RunningParameter.projectName = "privateweb";
    }
...
//
    ...
    public void postRequest(Map<String, String> param){
        ...
        logger.info("[RequestInfo]:" + requestSampler.getGetRequsetParams());
