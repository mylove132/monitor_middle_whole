...
import okjiaoyu.qa.middle.auto.testcase.privateweb.Pr_Login;
...
public class Crm extends TestBase {
    ...
    public void beforeSuite_normal() {
        RunningParameter.project_name = "crm_normal";
        RunningParameter.monitor_projectId = 31;
        RunningParameter.projectName = "crm";
    }

    @BeforeSuite(groups = {"exception"})
    public void beforeSuite_exception() {
        RunningParameter.project_name = "crm_exception";
        RunningParameter.monitor_projectId = 31;
        RunningParameter.projectName = "crm";
    }
    ...
    public void startup() {
        ...
        setAccount();
        //登录获取cookiec
        Crm_Login crm_login = new Crm_Login();
        crm_login.login();
