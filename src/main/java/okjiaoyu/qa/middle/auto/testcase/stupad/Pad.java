...
public class Pad extends TestBase {
    ...
    static {
        RunningParameter.projectName = "stupad";
//        String machine = Config.getGlobalValue("machine");
    ...
    public void setCommonUp() {
        ...
        account_commonUp.put("vs", "2.6.1.4_tcon2.0-debug");
        account_commonUp.put("vc", "87");
        account_commonUp.put("ua", "OKAY_EBOOK_S4_OKUI_5.0.7_20180729_T");
        account_commonUp.put("os", "Galileo");
        account_commonUp.put("sw", "480");
        account_commonUp.put("sh", "800");
        account_commonUp.put("contype", 3);
        account_commonUp.put("imei", "0");
        account_commonUp.put("mac", "02:00:00:00:00:00");
        account_commonUp.put("channel", "pad");
        account_commonUp.put("udid", "EFC45543C9427A014F104A9396696D53");
        account_commonUp.put("iccid", "isFake");
...
//            }
    ...
    public void beforeSuite_normal() {
        RunningParameter.project_name = "middle_stupad_normal";
        RunningParameter.monitor_projectId = 1;
    }

    @BeforeSuite(groups = {"exception"})
    public void beforeSuite_exception() {
        RunningParameter.project_name = "middle_stupad_exception";
        RunningParameter.monitor_projectId = 1;
    }
