 ...
 */
public class TeacherPad extends TestBase {
    ...
    public void getLoginToken(String token, JSONObject json) {
        if (!token.equals("miss")) {
            if (token.equals("used")) {
                ...
                json.put("token", buildExpiredToken(TeacherPad.account_token + "_expired"));
            } else {
    ...
    public void getLoginUid(String uid, JSONObject json) {
        if (!uid.equals("miss")) {
            if (uid.equals("used")) {
                ...
                json.put("uid", buildExpiredToken(TeacherPad.account_uid));
            } else {
                json.put("uid", uid);
            }
        }
